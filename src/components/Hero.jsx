      ...
      >
        <div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
          ...
          >
            <video
              ref={nextVideoRef}
              src={getVideosSrc(currentIndex === 4 ? 1 : currentIndex + 1)}
              loop
              muted
              autoPlay
              id="current-video"
      ...
      >
        <h1 className="special-font hero-heading absolute bottom-5 right-5 z-40 text-blue-75">G<b>A</b>MING </h1>
            <div className="mt-24 px-5 sm:px-10">
                ...
                <p className="mb-5 max-w-64 font-robert-regular text-blue-100">Enter the Mategame Layer<br/> Unleash the play Economy
                </p>
