...
const About = () => {
  ...
  return (
    <div id='about' className='min-h-screen w-screen mb-0'>
        <div className='relative mb-8 mt-36 flex flex-col items-center gap-5'>
            ...
            <div className='about-subtext'>
                <p>Join us in this epic journey and become a part of the adventure!</p>
                <p>Experience the thrill of exploration and the joy of discovery.</p>

            </div>

        </div>
        <div className='h-dvh w-screen relative mb-0' id='clip'>
